...
export default function Home() {
  ...
  return (
    <div className="min-h-screen hero-gradient">
      ...
      {/* Hero Section - Balanced spacing on mobile, CTA above fold */}
      <main className="max-w-7xl mx-auto px-5 md:px-6 py-12 md:py-20">
        <div className="text-center space-y-6 md:space-y-8">
          ...
          >
            <h2 className="text-[2.5rem] leading-tight md:text-7xl font-bold tracking-tight mb-3 md:mb-4">
              Your Dream Build,
              <br />
            ...
            <p className="text-base md:text-xl text-zinc-400 max-w-2xl mx-auto mt-4 md:mt-6 leading-relaxed">
          ...
          <motion.div
            ...
            className="racing-stripe max-w-md md:max-w-2xl mx-auto"
          />
          ...
          <div className="pt-2 md:pt-8">
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-10 md:px-12 py-4 md:py-4 rounded-full text-lg md:text-lg font-semibold transition-all hover:scale-105 hover:shadow-lg hover:shadow-red-600/50"
            >
              Start Customizing
            </button>
          </div>
